...
class ScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post scores_url, params: { score: { points: @score.points, round_id: @score.round_id, team_id: @score.team_id } }
    end
  ...
  test "should update score" do
    patch score_url(@score), params: { score: { points: @score.points, round_id: @score.round_id, team_id: @score.team_id } }
